...
<body class="login-page">
    <div class="login-wrapper">
        <div class="login-left">
            ...
            <h1>Kelola Portfolio <span>Frynn</span> dengan lebih profesional.</h1>
            <p>Masuk ke panel admin untuk menambahkan, mengedit, dan mengelola project yang tampil di website portfolio kamu.</p>
